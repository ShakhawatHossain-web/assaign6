...
const createSlider = () => {
  ...
  if (sliders.length < 2) {
    ...
    prevNext.className.add('added') = "prev-next d-flex w-100 justify-content-between align-items-center";
...
sliderBtn.addEventListener('click', function () {
  createSlider()
  document.getElementById('create-slider')
})'
